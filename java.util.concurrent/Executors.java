...
public class Executors {
     ...
     * workQueue使用LinkedBlockingQueue，没有设置范围，默认是最大值（Integer.MAX_VALUE），相当于一个无界队列。
     * 当线程池中的线程数量等于corePoolSize 时，如果继续提交任务，该任务会被添加到阻塞队列workQueue中，因为workQueue是无界队列，所以maximumPoolSize和参数都无效。
     */
     ...
     * 阻塞队列采用的SynchronousQueue：SynchronousQueue 不存储元素，数据必须从某个写线程交给某个读线程，而不是写到某个队列中等待被消费。
     *      
