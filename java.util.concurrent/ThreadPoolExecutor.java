...
public class ThreadPoolExecutor extends AbstractExecutorService {
     ...
     * 最大线程容量: 2^29-1=536870911
     */
    private static final int CAPACITY = (1 << COUNT_BITS) - 1;

    /**
     * 高3位表示线程池的状态 RUNNING -> SHUTDOWN -> STOP -> TIDYING
     */
    ...
    /***
     * 将整数c的低29位修改为0，获取线程池的状态
     *
     *  CAPACITY: 000 11111111111111111111111111111
     * ~CAPACITY: 111 00000000000000000000000000000  (~ 取反操作: 1变0,0变1)
     *                           &   (与操作,都为1才为1)
     *         c: 011 00000000000000000000000000000
     *            011 00000000000000000000000000000
     */
    ...
    private static boolean isRunning(int c) {
        return c < SHUTDOWN;   // SHUTDOWN: 000 00000000000000000000000000000
    }

    // 工作线程数尝试加1, 成功返回true;失败返回false
    private boolean compareAndIncrementWorkerCount(int expect) {
        return ctl.compareAndSet(expect, expect + 1);
    }

    // 工作线程数尝试减1, 成功返回true;失败返回false
    ...
    // 线程池中所有工作线程的集合。仅在持有mainLock锁时访问
    ...
    /***
     * 允许核心线程超时:
     *  1. 如果为false(默认)，则核心线程即使在空闲时也保持活动。
     *  2. 如果为true，核心线程使用keepAliveTime来超时等待工作。
     */
    ...
    /**
     * {@link "https://blog.csdn.net/john1337/article/details/102912070"}
     *
     * 此权限允许攻击者修改系统中任意线程的行为
     * 修改线程，例如通过调用线程的 interrupt、stop、suspend、resume、setDaemon、setPriority、setName 和 setUncaughtExceptionHandler 方法
     */
    ...
    private final class Worker extends AbstractQueuedSynchronizer implements Runnable {
        ...
        //在创建线程的时候，如果同时指定的需要执行的第一个任务。如果为 null，线程自己到任务队列中取任务执行
        Runnable firstTask;
